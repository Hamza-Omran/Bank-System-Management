...
private:
    ...
    static LogUser _convertLineToUserLogStructure(string line, string Seperator="#//#") {
        ...
        vLogUsers.Permission = stoi(data[3]);
        return vLogUsers;
    }

    static vector <LogUser> _loadLogUsersFromfile(){

        vector <LogUser> vLogUsers;
...
public:
    ...
    static vector<LogUser> GetRegisterLogData() {
        vector<LogUser> userlog = _loadLogUsersFromfile();
        return userlog;
    }
