...
public:
    struct stTransferLog {
        ...
        double AmountTransfered, FromBalance, ToBalance;
    };
...
private:
    ...
    static vector <stTransferLog> _loadTransferLogFromfile() {
        ...
        vector <stTransferLog> vLogUsers;
...
public:
    ...
    static vector<stTransferLog> GetTransferLogData() {
        vector<stTransferLog> transferlog = _loadTransferLogFromfile();
        return transferlog;
    }
